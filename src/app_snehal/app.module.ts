...
@NgModule({
  declarations: [
    AppComponent,		
    CiUsersComponent, HeadercompComponent, MyprofileComponent, LoginformComponent, CompaniesComponent, HomeComponentComponent, FooterComponent, CompaniesComponent, MyprofileComponent, CompanydetailsComponent
  ],
  imports: [
  BrowserModule,
	ReactiveFormsModule,
